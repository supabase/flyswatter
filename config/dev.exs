...
config :fly_swatter, FlySwatterWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "74KYbnA/VQ4766WZg7VLdozOL5X+n9cRjPYHSKRGSbH/vMtrWofxCFpcR3cbLUAr",
  watchers: [
...
config :fly_swatter, FlySwatterWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/fly_swatter_web/(live|views)/.*(ex)$",
      ~r"lib/fly_swatter_web/templates/.*(eex)$"
    ]
  ]
